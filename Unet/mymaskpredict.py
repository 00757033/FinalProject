...
def get_args():
    ...
    parser.add_argument('--model', '-m', default=r'C:\Users\Xsheep\Desktop\imageproject\my_Unet\checkpoint_epoch250.pth', metavar='FILE',
                        help='Specify the file in which the model is stored')
    parser.add_argument('--input', metavar='INPUT', 
        default=[r"test_mask/images/powder_uncover_0129.png","test_mask\images\scratch_3135.png","test_mask\images\powder_uneven_0215.png"]
