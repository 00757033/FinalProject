...
#全局变量进行路径配置
label_folder = 'runs\detect\exp13\labels'  #检测结果存放文件夹labels路径

raw_images_folder = 'runs\detect\exp13'  #检查图片存放文件夹raw_images路径

save_images_folder = 'runs\detect\exp13'  #保存图片文件夹save_image路径
